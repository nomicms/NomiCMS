...
(1, 1, 1, 1, 1, 'В данной теме пишем баги/ошибки которые вы нашли', '', '', 1539789901),
(2, 1, 1, 2, 1, 'Тут пишем предложения или замечания по движку ;-)', '', '', 1539790195),
(3, 2, 2, 3, 1, 'Всем привет B-)', '', '', 1539790454),
(4, 1, 1, 1, 1, 'Тема закреплена!', '', '', 1539790583),
(5, 2, 2, 3, 2, 'В целом, конечно, постоянный количественный рост и сфера нашей активности способствует повышению качества форм воздействия.', '', '', 1539790775),
(6, 2, 2, 3, 1, '[rep]User[/rep] Сложно сказать, почему элементы политического процесса неоднозначны и будут представлены в исключительно положительном свете. Банальные, но неопровержимые выводы, а также элементы политического процесса лишь добавляют фракционных разногласий и указаны как претенденты на роль ключевых факторов :bravo:', '', '', 1539790974),
(7, 2, 2, 3, 2, 'Не следует, однако, забывать, что синтетическое тестирование позволяет оценить значение первоочередных требований', 'admin', '[rep]User[/rep] Сложно сказать, почему элементы политического процесса неоднозначны и будут представлены в исключительно положительном свете. Банальные, но неопровержимые выводы, а также элементы политического процесса лишь добавляют фракционных разногласий и указаны как претенденты на роль ключевых факторов :bravo:', 1539791080),
(8, 2, 2, 3, 1, '[rep]User[/rep] хмм... :angry:', '', '', 1539795191),
(9, 2, 2, 4, 1, 'действительно :(', '', '', 1539794293),
(10, 2, 2, 4, 1, 'Тема закрыта!', '', '', 1539794298),
(11, 1, 1, 1, 2, 'Товарищи! рамки и место обучения кадров в значительной степени обуславливает создание дальнейших направлений развития!', '', '', 1539796336);
...
INSERT INTO `forum_topic` (`id`, `razdel`, `section`, `kto`, `name`, `time`, `last_message_time`, `is_top_topic`, `is_close_topic`) VALUES
(1, 1, 1, 1, 'Топ тема: Баги / Ошибки', 1539789901, 1539796336, 1, 0),
(2, 1, 1, 1, 'Предложения / Замечания', 1539790195, 1539790195, 0, 0),
(3, 2, 2, 1, 'Свободное общение', 1539790454, 1539795191, 0, 0),
(4, 2, 2, 1, 'Закрытая тема', 1539794293, 1539794293, 0, 1);
